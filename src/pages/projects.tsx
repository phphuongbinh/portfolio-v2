...
const FeaturedProject = ({
  ...
  return (
    <article className="relative">
      <div className="absolute -z-0 top-0 -right-4 w-[100%] h-[103%] bg-dark rounded-3xl"></div>
      <div className="w-full relative z-10 flex items-center justify-between rounded-3xl border-2 border-solid border-dark bg-light shadow-2xl space-x-6 p-12">
...
const Project = ({
  ...
  return (
    <article className=" relative">
      <div className="absolute -z-0 top-0 -right-4 w-[102%] h-[102%] bg-dark rounded-3xl"></div>
